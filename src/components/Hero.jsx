      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex md:ml-10 lg:ml-0 flex-col md:flex-row items-center lg:h-[90vh] justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10">
                <h1 className="lg:text-7xl text-4xl font-bold lg:leading-snug">Hi There, <br />I'm Fahim <span className="text-red-500">Rahman</span></h1>
                <p className="md:text-2xl text-xl mb-4">Web Developer & Designer</p>
                <p className="mb-4 text-lg text-gray-700">I'm a passoinate web developer with expertise in React, Express.js, Mongo-DB, Node.js and modern web technologies. I love solving problems with Javascript and creating functional websites that solve
